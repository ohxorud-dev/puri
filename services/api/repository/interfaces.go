...
type UserRepo interface {
	...
	BanUser(ctx context.Context, id int64, reason string, bannedBy int64) (*User, *Ban, error)
	UnbanUser(ctx context.Context, id int64, unbannedBy int64) (*User, error)
	UpdateBanReason(ctx context.Context, userID int64, reason string) (*Ban, error)
	SetRole(ctx context.Context, id int64, role string) (*User, error)
	GetActiveBan(ctx context.Context, userID int64) (*Ban, error)
